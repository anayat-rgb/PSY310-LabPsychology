...
expName = 'staircase task'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/anayatalesra/Desktop/psy310/staircase task/staircase task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Welcome to the experiment\nPlease press ‘right’ or ‘left’ depending on the orientation of the tilt shown\nPress ‘space’ to begin',
        font='Arial',
